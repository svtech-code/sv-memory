...
| :------------- | :----------------------- | :---------------------------------------------------------------------------------- |
| Claude Code    | `sv-memory setup claude-code` | MCP server config, `PreToolUse` + lifecycle hooks (`SessionStart`, `SessionEnd`, `PreCompact`, `SubagentStop`), `AGENTS.md` protocol, 29-tool permission allow-list |
...
| Antigravity CLI | `sv-memory setup antigravity` | MCP config, `PreToolUse` hooks (soft/strict), `AGENTS.md` protocol, 29-tool permission allow-list |
...
- **Permissions:** the 29 sv-memory tools are added to the `~/.claude/settings.json`
...
- **Permissions:** the 29 sv-memory tools are added to the Antigravity settings allow-list
  (`mcp(sv-memory/<tool>)`).
