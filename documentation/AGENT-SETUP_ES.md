...
| :-------------- | :--------------------------- | :----------------------------------------------------------------------------------------------- |
| Claude Code     | `sv-memory setup claude-code` | Config MCP, hooks `PreToolUse` + ciclo de vida (`SessionStart`, `SessionEnd`, `PreCompact`, `SubagentStop`), protocolo en `AGENTS.md`, allow-list de las 29 herramientas |
...
| Antigravity CLI | `sv-memory setup antigravity` | Config MCP, hooks `PreToolUse` (soft/strict), protocolo en `AGENTS.md`, allow-list de las 29 herramientas |
...
- **Permisos:** las 29 herramientas sv-memory se añaden al allow-list de
...
- **Permisos:** las 29 herramientas sv-memory se añaden al allow-list de Antigravity
  (`mcp(sv-memory/<tool>)`).
