...
// handleProposeSpec creates a spec change in the draft state, wires the
// AFFECTS edges to the affected code paths, and runs a pre-flight check against
// the project's rules/invariants before any code is written.
